    ...
    <div className="bg-purple-700 text-white">
      <nav className="flex items-center justify-between flex-wrap p-6">
        <div className="flex items-center flex-shrink-0">
          <h1 className="font-semibold text-3xl tracking-tight mr-6">Code With Companion</h1>
        </div>
        ...
        >
          ...
          <a className="block mt-4 lg:inline-block lg:mt-0  cursor-pointer text-stone-100 hover:text-white mr-4" 
          onClick={() => {
            onVideoToggle(userId);
            toggleVideoCss();
          }}>
            
            {video ? <FontAwesomeIcon className="fa-xl" icon={faVideoCamera} />:<FontAwesomeIcon className="fa-xl" icon={faVideoSlash} />}
            </a>
            <a className="block mt-4 lg:inline-block lg:mt-0  cursor-pointer text-stone-100 hover:text-white mr-10" onClick={() => {
            onAudioToggle(userId);
            toggleAudioCss();
          }}>

            {audio ? <FontAwesomeIcon className="fa-xl" size={70} icon={faMicrophoneLines} />:<FontAwesomeIcon className="fa-xl" icon={faMicrophoneLinesSlash} />}
            
            </a>
            <a className="block mt-4 text-lg lg:inline-block lg:mt-0 cursor-pointer text-stone-100 hover:text-white mr-10" onClick={handleClick}>
